...
public class EditorObjExporter : ScriptableObject
{
	...
	[MenuItem ("Helpers/Export/Export all MeshFilters in selection to separate OBJs")]
	...
	[MenuItem ("Helpers/Export/Export whole selection to single OBJ")]
	static void ExportWholeSelectionToSingle()
	{
		...
		if (exportedObjects > 0)
		{
			...
			string filename = EditorSceneManager.GetActiveScene().ToString() + "_" + exportedObjects;
	...
	[MenuItem ("Helpers/Export/Export each selected to single OBJ")]
