...
public class SceneTool : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        if (true == GUILayout.Button("Refresh"))
        {
            ...
            if (AssetDatabase.IsValidFolder(s_PathToTestScenes))            GatherTestScenes();
            if (AssetDatabase.IsValidFolder(s_PathToArtScenes))            GatherArtScenes();
        }
        ...
        GUILayout.Box(s_PathToTestScenes, GUILayout.MaxWidth(Screen.width));
        EditorGUILayout.Space();
        GUI.color = m_OldColor;
        ...
        EditorGUILayout.Space();
        GUI.color = Color.green;
        GUILayout.Box(s_PathToArtScenes, GUILayout.MaxWidth(Screen.width));
        EditorGUILayout.Space();
        GUI.color = m_OldColor;
